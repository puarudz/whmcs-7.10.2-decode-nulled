...
if (!$error) {
    ...
    foreach ($services as $service) {
        $statuses = array(WHMCS\Service\Status::TERMINATED, WHMCS\Service\Status::CANCELLED, WHMCS\Service\Status::FRAUD, WHMCS\Service\Status::PENDING);
        if (!in_array($service->id, $syncedServiceIds) && !in_array($service->domainStatus, $statuses)) {
            ...
            echo $service->id;
            echo "</a></td>\n                <td class=\"display-name\">";
            echo $service->serviceProperties->get($uniqueIdField);
            echo "</td>\n                <td class=\"primary-ip\">";
