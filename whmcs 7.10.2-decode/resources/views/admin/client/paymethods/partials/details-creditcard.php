...
echo AdminLang::trans("clients.ccUnsupported");
echo "\"\n                data-message-invalid=\"";
echo AdminLang::trans("clients.ccInvalid");
echo "\"\n                data-supported-cards=\"";
echo $supportedCardTypes;
