...
echo file_exists("../assets/img/marketconnect/" . $serviceOffering["vendorSystemName"] . "/logo.svg") ? "../assets/img/marketconnect/" . $serviceOffering["vendorSystemName"] . "/logo.svg" : "../assets/img/marketconnect/" . $serviceOffering["vendorSystemName"] . "/logo.png";
