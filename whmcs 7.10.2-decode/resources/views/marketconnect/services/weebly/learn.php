...
echo "<br />\n                    <span>\n                        ";
echo AdminLang::trans("marketConnect.perMo", array(":num" => $feed->getCostPrice("weebly_free")));
echo "                    </span>\n                </th>\n                <th>\n                    ";
...
echo "</td>\n                <td>\n                    ";
echo AdminLang::trans("marketConnect.perMo", array(":num" => $feed->getRecommendedRetailPrice("weebly_free")));
echo "                </td>\n                <td>\n                    ";
...
$this->insert("shared/configuration-activate", array("currency" => $currency, "service" => $service, "firstBulletPoint" => "Offer all 4 Weebly Plans", "landingPageRoutePath" => "store-websitebuilder-index", "serviceOffering" => $serviceOffering, "billingCycles" => $billingCycles, "products" => $products, "serviceTerms" => $serviceTerms));
echo "</div>\n";
$this->end();
