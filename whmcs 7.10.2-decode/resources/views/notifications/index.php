...
echo "</h2>\n\n<p>\n    <span id=\"createNewRuleSpan\"\n          style=\"display:inline-block;\"\n          data-toggle=\"tooltip\"\n          title=\"";
echo AdminLang::trans("notifications.needActiveProvider");
echo "\"\n    >\n        <a href=\"";
echo routePath("admin-setup-notifications-rule-create");
echo "\"\n           id=\"createNewRuleBtn\"\n           class=\"btn btn-default open-modal disabled\"\n           data-modal-size=\"modal-lg\"\n           data-modal-title=\"";
echo addslashes(AdminLang::trans("notifications.createNewRule"));
echo "\"\n           data-btn-submit-id=\"CreateRule\"\n           data-btn-submit-label=\"";
