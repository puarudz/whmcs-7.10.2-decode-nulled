...
{
    return array("DisplayName" => "Centova Cast", "APIVersion" => "1.0", "DefaultNonSSLPort" => "80", "DefaultSSLPort" => "443");
}
...
function centovacast_CreateAccount($params)
{
    ...
    $ccurl = centovacast_getccurl($params);
