...
{
    return array("DisplayName" => "License Software", "APIVersion" => "1.1", "RequiresServer" => false, "addonLicenseRequired" => true, "addonLicenseName" => "Licensing Addon", "AutoGenerateUsernameAndPassword" => false);
}
...
{
    $allowReissue = $params["configoption3"];
    $buttonarray = array();
    if ($allowReissue === "on") {
