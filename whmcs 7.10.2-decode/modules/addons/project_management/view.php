                        ...
                        if ($a == "loadtasklist") {
                            ...
                            if ($taskTemplate) {
                                foreach ($taskTemplate->tasks as $task) {
                                    $maxorder++;
                                    WHMCS\Database\Capsule::table("mod_projecttasks")->insert(array("projectid" => $projectId, "task" => $task["task"], "notes" => $task["notes"], "adminid" => $task["adminid"], "created" => WHMCS\Carbon::now()->toDateTimeString(), "order" => $maxorder));
                                }
                            }
                            redir("module=project_management&m=view&projectid=" . $projectid);
                        }
