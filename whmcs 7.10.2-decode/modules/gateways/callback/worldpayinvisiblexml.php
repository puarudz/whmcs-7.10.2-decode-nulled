...
$orderCode = WHMCS\Database\Capsule::table("tblgatewaylog")->where("gateway", "WPIORDERCODE" . $invoiceid)->value("data");
$echoData = WHMCS\Database\Capsule::table("tblgatewaylog")->where("gateway", "WPIECHODATA" . $invoiceid)->value("data");
$cvv = WHMCS\Database\Capsule::table("tblgatewaylog")->where("gateway", "WPICPDATA" . $invoiceid)->value("data");
if (!$echoData) {
...
WHMCS\Database\Capsule::table("tblgatewaylog")->where("gateway", "WPIECHODATA" . $invoiceid)->delete();
WHMCS\Database\Capsule::table("tblgatewaylog")->where("gateway", "WPIORDERCODE" . $invoiceid)->delete();
WHMCS\Database\Capsule::table("tblgatewaylog")->where("gateway", "WPICPDATA" . $invoiceid)->delete();
