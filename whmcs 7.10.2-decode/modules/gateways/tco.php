...
if (!function_exists("tco_config")) {
    ...
    function tco_reoccuring_request()
    {
        ...
        $queryParams = array("name" => $name, "price" => $recurring_amount, "startup_fee" => $startup_fee, "recurring" => "1", "recurrence" => $billing_cycle, "duration" => $billing_duration, "description" => $description, "currency" => $GATEWAY["currency"]);
        if ($demomode == "on") {
            $queryParams["demo"] = "Y";
        }
        $ch = curl_init();
