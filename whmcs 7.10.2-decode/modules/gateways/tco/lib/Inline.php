...
class Inline
{
    ...
    protected function buildHtmlForm(array $params, array $formParameters, array $recurringFormParameters = array())
    {
        ...
        $oneTimeFormParameters = array_merge($oneTimeFormParameters, array("li_0_type" => "product", "li_0_name" => "Invoice #" . $params["invoiceid"], "li_0_price" => $params["amount"], "li_0_startup_fee" => "0.00", "li_0_product_id" => "I" . $params["invoiceid"]));
        $items = "";
