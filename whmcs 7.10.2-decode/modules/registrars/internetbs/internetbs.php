...
function internetbs_config_validate(array $params)
{
    ...
    $commandUrl = $apiServerUrl . "Account/Balance/Get";
    ...
    if ($result === false) {
        throw new WHMCS\Exception\Module\InvalidConfiguration(internetbs_getconnectionerrormessage($errorMessage));
    }
    if ($result["status"] == "FAILURE") {
        throw new WHMCS\Exception\Module\InvalidConfiguration($result["message"]);
    }
}
