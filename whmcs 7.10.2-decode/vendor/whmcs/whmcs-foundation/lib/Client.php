...
class Client
{
    ...
    public function getDetails($contactid = "")
    {
        ...
        $details["email_verified"] = $this->clientModel->emailVerified;
    ...
    public function updateClient()
    {
        ...
        if (defined("ADMINAREA")) {
            ...
            $updatefieldsarray = array("firstname" => "First Name", "lastname" => "Last Name", "companyname" => "Company Name", "email" => "Email Address", "address1" => "Address 1", "address2" => "Address 2", "city" => "City", "state" => "State", "postcode" => "Postcode", "country" => "Country", "phonenumber" => "Phone Number", "billingcid" => "Billing Contact", "tax_id" => \Lang::trans(Billing\Tax\Vat::getLabel()));
        }
        $changelist = array();
        ...
        run_hook("ClientEdit", array_merge(array("userid" => $this->getID(), "isOptedInToMarketingEmails" => $this->clientModel->isOptedInToMarketingEmails(), "olddata" => $exinfo), $this->getDetails()));
        if (!defined("ADMINAREA")) {
