...
class S3StorageProvider implements StorageProviderInterface
{
    ...
    {
        $assetPrefixes = array(\WHMCS\File\FileAsset::TYPE_CLIENT_FILES => "client_files", \WHMCS\File\FileAsset::TYPE_DOWNLOADS => "downloads", \WHMCS\File\FileAsset::TYPE_EMAIL_ATTACHMENTS => "email_attachments", \WHMCS\File\FileAsset::TYPE_EMAIL_TEMPLATE_ATTACHMENTS => "template_attachments", \WHMCS\File\FileAsset::TYPE_EMAIL_IMAGES => "email_images", \WHMCS\File\FileAsset::TYPE_KB_IMAGES => "kb_images", \WHMCS\File\FileAsset::TYPE_PM_FILES => "projects", \WHMCS\File\FileAsset::TYPE_TICKET_ATTACHMENTS => "ticket_attachments");
