...
class Version720alpha1 extends IncrementalVersion
{
    ...
    {
        $templateExists = \WHMCS\Mail\Template::where("name", "SpamExperts Welcome Email")->first();
        if (!$templateExists) {
    ...
    {
        $templateExists = \WHMCS\Mail\Template::where("name", "Weebly Welcome Email")->first();
        if (!$templateExists) {
            $mailTemplate = new \WHMCS\Mail\Template();
    ...
    {
        $templateExists = \WHMCS\Mail\Template::where("name", "Direct Debit Payment Failed")->first();
        if (!$templateExists) {
            $mailTemplate = new \WHMCS\Mail\Template();
    ...
    {
        $templateExists = \WHMCS\Mail\Template::where("name", "Direct Debit Payment Confirmation")->first();
        if (!$templateExists) {
            $mailTemplate = new \WHMCS\Mail\Template();
    ...
    {
        $templateExists = \WHMCS\Mail\Template::where("name", "Direct Debit Payment Pending")->first();
        if (!$templateExists) {
            $mailTemplate = new \WHMCS\Mail\Template();
    ...
    {
        $templateExists = \WHMCS\Mail\Template::where("name", "Credit Card Payment Pending")->first();
        if (!$templateExists) {
            $mailTemplate = new \WHMCS\Mail\Template();
    ...
    {
        $templateExists = \WHMCS\Mail\Template::where("name", "Payment Reversed Notification")->first();
        if (!$templateExists) {
            $mailTemplate = new \WHMCS\Mail\Template();
