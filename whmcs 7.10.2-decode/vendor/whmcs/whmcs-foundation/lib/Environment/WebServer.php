...
final class WebServer
{
    ...
    {
        return in_array(strtolower(static::getServerFamily()), array("apache", "httpd"));
    }
    ...
    public static function getExternalCommunicationIp()
    {
        static $ip = NULL;
        if (is_null($ip)) {
            $contents = curlCall("https://api1.whmcs.com/ip/get", "", array("CURLOPT_RETURNTRANSFER" => 1, "CURLOPT_FOLLOWLOCATION" => 1));
            if (!empty($contents)) {
