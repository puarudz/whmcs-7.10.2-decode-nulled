...
class License
{
    ...
    protected function makeCall($url, $query_string, $timeout = 5)
    {
		...
		*/
		...
		$results["registeredname"] = "AtoZNull.net";
		$results["productname"] = "WHMCS Nuled";
		$results["productid"] = "5";
