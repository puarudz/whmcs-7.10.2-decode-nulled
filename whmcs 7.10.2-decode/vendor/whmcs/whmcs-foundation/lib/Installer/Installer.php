...
class Installer
{
    ...
    protected function createInitialStorageConfigurations(array $localStorage = array())
    {
        ...
        $assetTypeLocalPaths = array(\WHMCS\File\FileAsset::TYPE_CLIENT_FILES => $attachmentsConfiguration, \WHMCS\File\FileAsset::TYPE_DOWNLOADS => $downloadsConfiguration, \WHMCS\File\FileAsset::TYPE_EMAIL_ATTACHMENTS => $emailAttConfiguration, \WHMCS\File\FileAsset::TYPE_EMAIL_IMAGES => $downloadsConfiguration, \WHMCS\File\FileAsset::TYPE_EMAIL_TEMPLATE_ATTACHMENTS => $emailTmplAttConfiguration, \WHMCS\File\FileAsset::TYPE_KB_IMAGES => $kbConfiguration, \WHMCS\File\FileAsset::TYPE_PM_FILES => $pmFilesConfiguration, \WHMCS\File\FileAsset::TYPE_TICKET_ATTACHMENTS => $ticketAttConfiguration);
