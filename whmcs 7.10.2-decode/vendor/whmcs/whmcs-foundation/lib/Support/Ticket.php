...
class Ticket extends \WHMCS\Model\AbstractModel
{
    ...
    {
        return array(ucfirst(self::PRIORITY_LOW) => self::PRIORITY_LOW, ucfirst(self::PRIORITY_MEDIUM) => self::PRIORITY_MEDIUM, ucfirst(self::PRIORITY_HIGH) => self::PRIORITY_HIGH);
    }
}
