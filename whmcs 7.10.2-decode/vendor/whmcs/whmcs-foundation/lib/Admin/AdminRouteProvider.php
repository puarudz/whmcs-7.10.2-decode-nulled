...
class AdminRouteProvider implements \WHMCS\Route\Contracts\ProviderInterface
{
    ...
    public function getRoutes()
    {
        $adminRoutes = array("/admin/account" => new Account\AccountRouteProvider(), "/admin/apps" => new Apps\AppsRouteProvider(), "/admin/setup/notifications" => new Setup\Notifications\NotificationsRouteProvider(), "/admin/setup/general/uripathmgmt" => array(array("method" => array("GET", "POST"), "name" => "dev-test", "path" => "/view", "handle" => array("WHMCS\\Admin\\Setup\\General\\UriManagement\\ConfigurationController", "view"))), "/admin/setup/payments" => array(array("method" => array("POST"), "name" => "admin-setup-payments-deletelocalcards", "path" => "/deletelocalcards", "handle" => array("WHMCS\\Admin\\Client\\PayMethod\\PayMethodController", "clearLocalCardPayMethods"), "authentication" => "admin", "authorization" => function () {
            ...
            return (new ApplicationSupport\Route\Middleware\Authorization())->requireCsrfToken();
        })), "/admin/billing" => new Billing\BillingRouteProvider(), "/admin/client" => new Client\ClientRouteProvider(), "/admin/support" => new Support\SupportRouteProvider(), "/admin/tld" => new Setup\Tld\TldRouteProvider(), "/admin" => array(array("method" => array("POST"), "name" => "admin-image-upload", "path" => "/image/upload/{type:\\w+}", "handle" => array("WHMCS\\Admin\\Controller\\ImageController", "uploadImage"), "authentication" => "admin", "authorization" => function () {
            return (new ApplicationSupport\Route\Middleware\Authorization())->requireCsrfToken();
        }), array("method" => array("GET"), "name" => "admin-image-recent-uploads", "path" => "/image/recent/{type:\\w+}", "authentication" => "admin", "handle" => array("WHMCS\\Admin\\Controller\\ImageController", "recentlyUploaded")), array("method" => array("POST"), "name" => "admin-notes-save", "path" => "/profile/notes", "authentication" => "admin", "authorization" => function () {
            return (new ApplicationSupport\Route\Middleware\Authorization())->requireCsrfToken();
        ...
        }, "handle" => array("\\WHMCS\\Admin\\Controller\\HomepageController", "marketingConversion")), array("method" => array("POST"), "name" => "admin-dismiss-global-warning", "path" => "/dismiss-global-warning", "authentication" => "admin", "authorization" => function () {
            return (new ApplicationSupport\Route\Middleware\Authorization())->requireCsrfToken();
            ...
            return (new ApplicationSupport\Route\Middleware\Authorization())->requireCsrfToken();
        }, "handle" => array("WHMCS\\Admin\\Controller\\HomepageController", "dismissMarketConnectProductPromo"))));
