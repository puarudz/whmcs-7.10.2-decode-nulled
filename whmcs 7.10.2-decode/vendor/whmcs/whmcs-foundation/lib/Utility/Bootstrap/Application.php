...
class Application extends AbstractBootstrap
{
    ...
    public static function getSingletons()
    {
        return array("config" => function () {
            ...
            return $server;
        }, "oauth2_sso" => function ($container, $data) {
            $storage = new \WHMCS\ApplicationLink\Storage\Whmcs();
            ...
            if ($data && is_array($data) && !empty($data["request"]) && $data["request"] instanceof \OAuth2\RequestInterface) {
    ...
    {
        return array("\\WHMCS\\Log\\LogServiceProvider", "\\WHMCS\\Route\\RouteServiceProvider", "\\WHMCS\\Application\\ApplicationServiceProvider", "\\WHMCS\\Api\\ApiServiceProvider", "\\WHMCS\\Smarty\\SmartyServiceProvider", "\\WHMCS\\View\\ViewServiceProvider", "\\WHMCS\\ClientArea\\ClientAreaServiceProvider", "\\WHMCS\\MarketConnect\\MarketConnectServiceProvider", "\\WHMCS\\Cart\\CartServiceProvider", "\\WHMCS\\Authentication\\Remote\\ServiceProvider", "\\WHMCS\\File\\StorageServiceProvider", "WHMCS\\Payment\\PaymentServiceProvider");
    }
}
