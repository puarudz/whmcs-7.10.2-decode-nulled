...
class PasswordResetController
{
    ...
    public function changePerform(\WHMCS\Http\Message\ServerRequest $request)
    {
        ...
        if ($newPassword !== "" && !$validate->hasErrors()) {
            ...
            $view->setTemplateVariables(array("successTitle" => \Lang::trans("pwresetvalidationsuccess"), "successMessage" => sprintf(\Lang::trans("pwresetsuccessdesc"), "<a href=\"" . $assetHelper->getWebRoot() . "/clientarea.php\">", "</a>")));
            return $view;
        }
        $this->setInnerTemplate("change-prompt", $view);
