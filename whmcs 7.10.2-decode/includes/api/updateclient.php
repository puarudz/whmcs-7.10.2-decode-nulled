...
try {
    if ($clientemail = App::getFromRequest("clientemail")) {
...
if (App::isInRequest("email_preferences", "domain")) {
    try {
        ...
        $apiresults = array("result" => "error", "message" => "You must have at least one email address enabled to receive domain" . " related notifications as required by ICANN." . " To disable domain notifications, please create an alternative contact" . " that is set to receive them");
        return NULL;
    } catch (Exception $e) {
...
$updatequery = "";
$fieldsarray = array("firstname", "lastname", "companyname", "email", "address1", "address2", "city", "state", "postcode", "country", "phonenumber", "tax_id", "credit", "taxexempt", "notes", "status", "language", "currency", "groupid", "taxexempt", "latefeeoveride", "overideduenotices", "billingcid", "separateinvoices", "disableautocc", "datecreated", "securityqid", "lastlogin", "ip", "host");
