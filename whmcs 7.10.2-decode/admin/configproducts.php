...
$ajaxActions = array("module-settings" => "getModuleSettings", "toggle-metric" => "toggleMetric", "metric-pricing" => "getMetricPricing", "save-metric-pricing" => "saveMetricPricing");
...
if ($action == "") {
    ...
    if ($action == "edit") {
        try {
            $product = WHMCS\Product\Product::findOrFail($id);
        ...
        if ($server->isMetaDataValueSet("NoEditModuleSettings") && $server->getMetaDataValue("NoEditModuleSettings")) {
            ...
            echo "</select> <img src=\"images/loading.gif\" id=\"moduleSettingsLoader\" class=\"hidden\"></td>\n<td class=\"fieldlabel\" width=\"15%\">";
        ...
        if ($action == "create") {
            ...
            if ($action == "duplicate") {
                ...
                if ($action == "creategroup" || $action == "editgroup") {
                    ...
                    echo $name;
                    echo "\" class=\"form-control input-400 input-inline\" placeholder=\"";
