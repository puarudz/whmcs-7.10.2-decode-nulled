...
if (!$newuserid) {
    ...
    foreach ($tables_array as $table) {
        update_query($table, array("userid" => $resultinguserid), array("userid" => $deleteuser));
    }
    update_query("tblcredit", array("clientid" => $resultinguserid), array("clientid" => $deleteuser));
    $userid = $newuserid;
    ...
    WHMCS\Payment\PayMethod\Model::where("contact_type", "Client")->where("contact_id", $deleteuser)->update(array("contact_id" => $resultinguserid));
