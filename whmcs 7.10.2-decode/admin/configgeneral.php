    ...
    if ($action == "deleteapiip") {
        ...
        if ($action == "deletetrustedproxyip") {
            ...
            if ($action == "save") {
                ...
                if ($continuousinvoicegeneration == "on" && !WHMCS\Config\Setting::getValue("ContinuousInvoiceGeneration")) {
            ...
            $cardTypes = array("Visa", "MasterCard", "Discover", "American Express", "JCB", "Diners Club", "Maestro", "Dankort", "Forbrugsforeningen", "UnionPay");
            ...
            $isAutoAuth = (bool) WHMCS\Config\Setting::getValue(WHMCS\Authentication\Client::SETTING_ALLOW_AUTOAUTH);
            echo "    <tr>\n        <td class=\"fieldlabel\">\n            ";
            echo $aInt->lang("general", "allowautoauth");
            echo "        </td>\n        <td class=\"fieldarea\">\n            ";
            echo $aInt->lang("general", "allowautoauthinfo");
            echo "                <a href=\"https://docs.whmcs.com/AutoAuth\" class=\"btn-link\" target=\"_blank\">\n                    (";
            echo $aInt->lang("global", "deprecated");
            echo ")\n                </a>\n            <br />\n            <label class=\"radio-inline\">\n                <input type=\"radio\" name=\"allowautoauth\" value=\"1\"\n                    ";
            echo $isAutoAuth ? " checked" : "";
            echo ">\n                ";
            echo $aInt->lang("global", "enabled");
            echo "            </label>\n            <br />\n            <label class=\"radio-inline\">\n                <input type=\"radio\" name=\"allowautoauth\" value=\"0\"\n                    ";
            echo !$isAutoAuth ? " checked" : "";
            echo ">\n                ";
            echo $aInt->lang("global", "disabled") . " (" . $aInt->lang("global", "default") . ")";
            echo "            </label>\n        </td>\n    </tr>\n</table>\n\n";
            echo $aInt->nextAdminTab();
            echo "\n<table class=\"form\" width=\"100%\" border=\"0\" cellspacing=\"2\" cellpadding=\"3\">\n<tr><td class=\"fieldlabel\" style=\"min-width:200px;\">";
