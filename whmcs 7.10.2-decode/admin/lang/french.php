...
$_ADMINLANG['general']['allowautoauth'] = "Allow AutoAuth";
$_ADMINLANG['general']['allowautoauthinfo'] = "AutoAuth allows automatic client login from your own trusted third party code";
