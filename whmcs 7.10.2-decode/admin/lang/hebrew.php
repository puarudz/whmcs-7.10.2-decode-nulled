...
$_ADMINLANG['clients']['ccUnsupported'] = "לצערנו אנחנו לא מכבדים את בוג הכרטיס שהשתמשתם בו. אנא השתמשו בכרטיס אחר.";
...
$_ADMINLANG['automation']['cronLabel'] = "The System Cron is responsible for automating tasks within WHMCS and must be configured to run periodically by the server environment that hosts the WHMCS installation.";
...
$_ADMINLANG['general']['allowautoauth'] = "אפשר אוטואישור (AutoAuth)";
$_ADMINLANG['general']['allowautoauthinfo'] = "אוטואישור מאפשר התחברות אוטומטית של לקוחות באמצעות קוד של צד שלישי שאתם סומכים עליו";
...
$_ADMINLANG['taxconfig']['euTaxValidationDescription'] = "אימות מספר ח.פ. / מספר עוסק מורשה במהלך תהליך ההרשמה והרכישה של הלקוח באמצאות שירותי אתר VIES.";
...
$_ADMINLANG['sendmessage']['skippedduplicate'] = "דילוג על כתובות דואר אלקטרוני כפולות עבור מזהה לקוח";
...
$_ADMINLANG['storage']['local']['local_path'] = "תיקייה מקומית";
