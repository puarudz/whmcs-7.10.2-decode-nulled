...
if ($action == "validateOrder") {
    ...
    if ($missingFields) {
        $aInt->jsonResponse(array("success" => false, "title" => AdminLang::trans("orders.errors.requiredFields"), "message" => AdminLang::trans("orders.errors.requiredFieldsMsg")));
    }
