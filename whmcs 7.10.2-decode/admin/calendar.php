...
if ($action == "fetch") {
    ...
    $startValue = WHMCS\Carbon::createFromFormat("Y-m-d H:i", (string) $dateString . " " . $time)->toAdminDateTimeFormat();
    $endValue = WHMCS\Carbon::createFromFormat("Y-m-d H:i", (string) $dateString . " 23:59")->toAdminDateTimeFormat();
...
if ($action == "save") {
    ...
    $adminDateTimeFormat = WHMCS\Carbon::getAdminDateFormat(true);
