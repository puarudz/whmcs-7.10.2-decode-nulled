...
$modalHtml .= $aInt->modal("CancelSubscription", $aInt->lang("services", "cancelSubscription"), $aInt->lang("services", "cancelSubscriptionSure"), array(array("title" => $aInt->lang("global", "yes"), "onclick" => "cancelSubscription()", "class" => "btn-primary"), array("title" => $aInt->lang("global", "no"))));
