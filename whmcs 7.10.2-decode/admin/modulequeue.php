...
$queueData = localAPI("GetModuleQueue", array("relatedId" => (int) App::getFromRequest("relatedId"), "serviceType" => App::getFromRequest("serviceType"), "moduleName" => App::getFromRequest("moduleName"), "moduleAction" => App::getFromRequest("moduleAction"), "since" => App::getFromRequest("since")));
