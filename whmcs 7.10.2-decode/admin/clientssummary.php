    ...
    if ($action == "massaction") {
        ...
        if ($massupdate || $masscreate || $masssuspend || $massunsuspend || $massterminate || $masschangepackage || $masschangepw) {
            ...
            if ($seldomains) {
                ...
                if (in_array($status, array("Suspended", "Terminated", "Completed"))) {
...
if ($datecreated == "0000-00-00") {
    ...
    $intervalArrays = array(array($carbonDateCreated->diffInMonths(), "months", "month"), array($carbonDateCreated->diffInDays(), "days", "day"));
    $diffValue = 1;
    $diffInterval = "day";
