...
if ($action == "save") {
    ...
    if ($id) {
        if ($hours != 0) {
            if (strpos($description, " " . Lang::trans("billableitemshours") . " @ ")) {
                $description = substr($description, 0, strrpos($description, " - ")) . " - " . $hours . " " . Lang::trans("billableitemshours") . " @ " . $amount . "/" . Lang::trans("billableitemshour");
            }
            $amount = $amount * $hours;
        }
        ...
        if ($hours != 0) {
            $description .= " - " . $hours . " " . Lang::trans("billableitemshours") . " @ " . $amount . "/" . Lang::trans("billableitemshour");
            $amount = $amount * $hours;
        }
