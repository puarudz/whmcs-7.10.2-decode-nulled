...
if ($sub == "save") {
    ...
    foreach ($currentConfig as $setting => $value) {
        if ($setting == "DomainRenewalNotices") {
            ...
            if (isset($settingsToSave[$setting])) {
                continue;
            }
...
echo AdminLang::trans("automation.cronLabel");
echo "    </span>\n</div>\n<div class=\"alert alert-info\" style=\"min-height: 68px;\">\n    <i class=\"fas fa-info-circle fa-3x pull-left fa-fw\"></i>\n    <div style=\"margin-left: 56px;\">\n        ";
echo AdminLang::trans("automation.cronSample");
echo "    </div>\n</div>\n\n<div class=\"cron-command input-group\">\n    ";
$cronCommand = WHMCS\Environment\Php::getPreferredCliBinary() . " -q " . $whmcs->getCronDirectory() . "/cron.php";
$copyToClipboard = AdminLang::trans("global.clipboardCopy");
echo "    <span class=\"input-group-addon\">Cron Command</span>\n    <span class=\"input-group-addon\" style=\"border-right: 0;\">*/5 * * * *</span>\n    <input type=\"text\"\n           id=\"cronPhp\"\n           value=\"";
echo $cronCommand;
